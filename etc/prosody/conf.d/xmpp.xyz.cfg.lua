...
http_external_url = "https://http.xmpp.xyz/"
...
turncredentials_host = "turn.xmpp.xyz"

--INSERT_SECRETS--

Component "http.xmpp.xyz" "http_file_share"
...
modules_enabled = { "muc_mam", "muc_limits", "muc_block_pm", "muc_moderation", "muc_restrict_media" };
muc_event_rate = 1
muc_burst_factor = 6
